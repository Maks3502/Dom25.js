...
// const listAnimal = document.querySelectorAll(".list-animal");
// const lenghtAnimal = listAnimal.length;
// console.log(lenghtAnimal);
...
// const lenghtProduct = listProduct.length;
...
// const listTehnology = document.querySelectorAll(".list-tehnology");
// const tehnologyItem = itTehnology.map((Tehnologys) => `<li class = "item-tehno"><h2 class="name-tehno">${Tehnologys}</h2></li>`).join();
// const lenghtTehnology = listTehnology.length;
// console.log(lenghtTehnology);
